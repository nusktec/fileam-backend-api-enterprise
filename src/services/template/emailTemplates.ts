import { emailStyleBlock } from "./emailSharedStyles";
...
const EMAIL_COMMON_EXTRA = `
        .header { background-color: #ffffff; padding: 32px 24px; text-align: center; border-bottom: 1px solid #e9ecef; }
        .logo { display: block; margin: 0 auto 16px; max-height: 48px; max-width: 100%; width: auto; height: auto; }
        ...
        .message { font-size: 16px; color: #4a4a4a; margin-bottom: 24px; text-align: center; line-height: 1.7; word-wrap: break-word; }
        .otp-container { border: 2px solid ${PRIMARY_COLOR}; }
        ...
        .security-text { color: #004d4d; font-size: 14px; word-wrap: break-word; }
        ...
        .social-link { display: inline-block; margin: 4px 10px; color: ${PRIMARY_COLOR}; text-decoration: none; font-size: 14px; }
`;
...
<head>
    ...
    <style>${emailStyleBlock(EMAIL_COMMON_EXTRA)}</style>
</head>
<body>
    <div class="container">
        <div class="header">
...
<head>
    ...
    <style>${emailStyleBlock(`${EMAIL_COMMON_EXTRA}
        .greeting { font-size: 28px; }
        .success-container { background-color: #e6f7f7; border-radius: 12px; padding: 24px 16px; text-align: center; margin: 24px 0; border: 2px solid ${PRIMARY_COLOR}; max-width: 100%; }
        .success-icon { font-size: 48px; margin-bottom: 15px; }
        .success-text { color: #004d4d; font-size: 18px; font-weight: 600; }
        .features { background-color: #f8fafc; border-radius: 12px; padding: 24px 16px; margin: 24px 0; max-width: 100%; }
        .features-title { font-size: 20px; font-weight: 600; color: #1a1a1a; margin-bottom: 20px; text-align: center; }
        .feature-item { margin: 12px 0; padding: 10px; background: white; border-radius: 8px; border-left: 4px solid ${PRIMARY_COLOR}; }
        .feature-icon { font-size: 18px; color: ${PRIMARY_COLOR}; font-weight: bold; }
        .feature-text { color: #4a4a4a; font-size: 16px; display: block; margin-top: 4px; }
        .cta-section { text-align: center; margin: 24px 0; }
        .cta-button { display: inline-block; background-color: ${PRIMARY_COLOR}; color: white !important; padding: 15px 24px; text-decoration: none; border-radius: 8px; font-weight: 600; font-size: 16px; max-width: 100%; }
    `)}</style>
</head>
<body>
    <div class="container">
...
<head>
    ...
    <style>${emailStyleBlock(`${EMAIL_COMMON_EXTRA}
        ...
        .btn { display: inline-block; background-color: ${PRIMARY_COLOR}; color: white !important; padding: 12px 24px; text-decoration: none; border-radius: 8px; font-weight: 600; margin: 8px 6px; max-width: 100%; }
    `)}</style>
</head>
<body>
    <div class="container">
