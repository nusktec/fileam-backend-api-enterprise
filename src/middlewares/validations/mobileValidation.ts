...
export const validateCreateEmployee = [
  ...
  check("nhisHealthInsuranceMonthly").optional().isFloat({ min: 0 }),
  check("lifeAssurancePremiumMonthly").optional().isFloat({ min: 0 }),
  check("mortgageInterestMonthly").optional().isFloat({ min: 0 }),
  handleValidation,
];
