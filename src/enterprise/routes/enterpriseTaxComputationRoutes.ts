...
router.post("/vat-computation/calculate", enterpriseValidations.validateCalculateVat, calculateVat);
router.get("/vat-computation/results", getVatResults);
router.get("/vat-computation/report/download", downloadVatReport);
router.post("/vat-computation/submit-return", enterpriseValidations.validateSubmitVatReturn, submitVatReturn);
