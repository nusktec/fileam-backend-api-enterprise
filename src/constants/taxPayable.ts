...
export const PAYABLE_STATUS = ["pending", "paid", "overpaid", "partially_paid"] as const;
export type PayableStatus = (typeof PAYABLE_STATUS)[number];

export const PAYMENT_RECORD_STATUS = ["pending", "completed", "failed", "refunded"] as const;
