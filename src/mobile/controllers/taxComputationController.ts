...
export const getTaxComputation = async (req: IRequest, res: Response): Promise<void> => {
  try {
    ...
    res.status(HttpStatusCode.OK).json(outJson(true, "Tax computation retrieved", data));
  } catch (error) {
    res
